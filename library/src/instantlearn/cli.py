...
class InstantLearnCLI:
    """This class is the entry point for the Geti Instant Learn CLI."""
    ...
    @staticmethod
    def _instantlearn_subcommands() -> dict[str, str]:
    ...
    def _add_subcommands(self) -> None:
        ...
        for name, description in self._instantlearn_subcommands().items():

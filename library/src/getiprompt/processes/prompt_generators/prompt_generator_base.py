...
from getiprompt.types import Features, Priors, Similarities
...
class SimilarityPromptGenerator(PromptGenerator):
    ...
    Examples:
        >>> from getiprompt.processes.prompt_generators import SimilarityPromptGenerator
...
class FeaturePromptGenerator(PromptGenerator):
    ...
    Examples:
        >>> from getiprompt.processes.prompt_generators import FeaturePromptGenerator
        >>> from getiprompt.types import Features, Priors
        >>>

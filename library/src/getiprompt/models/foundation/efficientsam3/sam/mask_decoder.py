...
# TODO: Consider moving the SAM1-style mask decoder to a shared location
# if SAM3 also needs this decoder architecture in the future.
...
class MLP(nn.Module):
    def __init__(
        ...
        self.layers = nn.ModuleList(
            map(nn.Linear, [input_dim] + h, h + [output_dim]),
        )

...
from transformers import CLIPTextConfig, PretrainedConfig as PreTrainedConfig
from transformers.models.auto import AutoConfig


# Local config mapping for SAM3 model types - will be populated after class definitions
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(backbone_config, dict):
            ...
            backbone_config = _SAM3_CONFIG_MAPPING[backbone_config["model_type"]](**backbone_config)
        elif backbone_config is None:
            backbone_config = _SAM3_CONFIG_MAPPING["sam3_vit_model"]()

...
class TestFolderDatasetSampleLoading:
    ...
    @patch("getiprompt.data.base.base.read_image")
    @patch("getiprompt.data.folder.dataset.read_mask")
...
class TestFolderDatasetFiltering:
    ...
    def test_get_reference_dataset(self, multi_category_dataset: FolderDataset) -> None:
        ...
        assert all(any(refs) for refs in ref_dataset.df["is_reference"].to_list())
    ...
    def test_get_target_dataset(self, multi_category_dataset: FolderDataset) -> None:
        ...
        # All should have no reference instances (all False)
        assert all(not any(refs) for refs in target_dataset.df["is_reference"].to_list())

...
from getiprompt.scripts.benchmark import perform_benchmark_experiment, load_dataset_by_name, predict_on_dataset
...
class TestBenchmarkModelHandling:
    ...
    def test_predict_on_dataset_single_model(self):
        ...
        with patch('getiprompt.scripts.benchmark.load_model') as mock_load_model, \
             ...
             patch('getiprompt.scripts.benchmark.handle_output_path') as mock_handle_path:
...
class TestBenchmarkOutputHandling:
    ...
    def test_output_directory_creation(self):
        ...
        with patch('getiprompt.scripts.benchmark.Path.mkdir') as mock_mkdir, \
            ...
            mock_parse_args.return_value = ([MagicMock(value="lvis")], [MagicMock(value="Matcher")], [MagicMock(value="SAM-HQ-tiny")])
    ...
    def test_results_saving(self):
        ...
        with patch('getiprompt.scripts.benchmark.get_arguments') as mock_get_args, \
             patch('getiprompt.scripts.benchmark.parse_experiment_args') as mock_parse_args, \
             patch('getiprompt.scripts.benchmark.load_dataset_by_name') as mock_load_dataset, \
             patch('getiprompt.scripts.benchmark.load_model') as mock_load_model, \
             patch('getiprompt.scripts.benchmark.predict_on_dataset') as mock_predict, \
...
class TestBenchmarkIntegration:
    ...
    def test_perform_benchmark_experiment_with_custom_args(self):
        ...
        with patch('getiprompt.scripts.benchmark.parse_experiment_args') as mock_parse_args, \
             patch('getiprompt.scripts.benchmark.load_dataset_by_name') as mock_load_dataset, \
             patch('getiprompt.scripts.benchmark.load_model') as mock_load_model, \
             patch('getiprompt.scripts.benchmark.predict_on_dataset') as mock_predict, \
             patch('getiprompt.scripts.benchmark._save_results') as mock_save, \

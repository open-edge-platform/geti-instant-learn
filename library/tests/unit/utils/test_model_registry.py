...
from getiprompt.models.registry import (
    MODEL_REGISTRY,
    Capability,
    ModelMetadata,
    ModelType,
...
class TestStrEnums:
    ...
    def test_model_type_is_str_enum(self):
    ...
    def test_modality_is_str_enum(self):
...
class TestModelRegistry:
    ...
    def test_all_entries_are_model_metadata(self):
...
class TestGetModelsByType:
    ...
    def test_get_models_by_type_with_string(self):
...
class TestGetModelsByCapability:
    ...
    def test_get_segmentation_capable(self):
    ...
    def test_get_encoding_capable(self):
...
class TestIsValidModel:
    ...
    def test_valid_model_with_matching_type(self):
    ...
    def test_valid_model_with_wrong_type(self):

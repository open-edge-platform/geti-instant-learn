...
"""Tests for LocalFeatureExtractor class."""
...
class TestLocalFeatureExtractor:
    """Test cases for LocalFeatureExtractor class."""

    def test_init(self) -> None:
        """Test LocalFeatureExtractor initialization."""
        extractor = LocalFeatureExtractor(
            input_size=224,
            patch_size=14,
            device="cpu",
        )
        pytest.assume(isinstance(extractor, LocalFeatureExtractor))
    ...
    def test_forward_single_image_single_mask(self) -> None:
        """Test LocalFeatureExtractor with single image and single mask."""
        extractor = LocalFeatureExtractor(
            input_size=224,
            patch_size=14,
            device="cpu",
    ...
    def test_forward_multiple_images_multiple_masks(self) -> None:
        """Test LocalFeatureExtractor with multiple images and multiple masks."""
        extractor = LocalFeatureExtractor(
            input_size=224,
            patch_size=14,
            device="cpu",
    ...
    def test_forward_multiple_classes_same_image(self) -> None:
        """Test LocalFeatureExtractor with multiple classes in the same image."""
        extractor = LocalFeatureExtractor(
            input_size=224,
            patch_size=14,
            device="cpu",
    ...
    def test_forward_empty_mask(self) -> None:
        """Test LocalFeatureExtractor with empty mask."""
        extractor = LocalFeatureExtractor(
            input_size=224,
            patch_size=14,
            device="cpu",
    ...
    def test_forward_different_input_sizes(self) -> None:
        """Test LocalFeatureExtractor with different input sizes."""
        input_size = 336
        patch_size = 14
    ...
    def test_forward_different_embedding_dims(self) -> None:
        """Test LocalFeatureExtractor with different embedding dimensions."""
        extractor = LocalFeatureExtractor(
            input_size=224,
            patch_size=14,
            device="cpu",
    ...
    def test_forward_large_mask_region(self) -> None:
        """Test LocalFeatureExtractor with a large mask region."""
        extractor = LocalFeatureExtractor(
            input_size=224,
            patch_size=14,
            device="cpu",
    ...
    def test_forward_same_class_id_multiple_masks(self) -> None:
        """Test LocalFeatureExtractor with multiple masks for the same class."""
        extractor = LocalFeatureExtractor(
            input_size=224,
            patch_size=14,
            device="cpu",
    ...
    def test_forward_different_configurations(self, input_size: int, patch_size: int) -> None:
        """Test LocalFeatureExtractor with different input_size and patch_size configurations."""
        extractor = LocalFeatureExtractor(
            input_size=input_size,
            patch_size=patch_size,
            device="cpu",

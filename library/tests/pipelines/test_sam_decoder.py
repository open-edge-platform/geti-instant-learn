...
class TestSamDecoderInitialization:
    ...
    def test_initialization_with_defaults(self, mock_sam_predictor: SamHQPredictor) -> None:
    ...
    def test_initialization_with_custom_params(self, mock_sam_predictor: SamHQPredictor) -> None:
    ...
    def test_initialization_creates_transform(self, mock_sam_predictor: SamHQPredictor) -> None:
...
class TestSamDecoderPreprocessing:
    ...
    def test_preprocess_inputs_basic(
        ...
        preprocessed_images, preprocessed_points, preprocessed_boxes, labels, original_sizes = sam_decoder.preprocess_inputs(
            [sample_image],
...
class TestSamDecoderPointPreprocessing:
    ...
    def test_point_preprocess_basic(self) -> None:
    ...
    def test_point_preprocess_multiple_positive(self) -> None:
    ...
    def test_point_preprocess_no_negative(self) -> None:
        ...
        assert final_coords.shape == (2, 1, 3)  # [2_positive, 1_positive + 0_negative, 3_coords]
        assert final_labels.shape == (2, 1)      # [2_positive, 1_positive + 0_negative]

    def test_point_preprocess_no_positive(self) -> None:
    ...
    def test_remap_preprocessed_points(self) -> None:
...
class TestSamDecoderForward:
    ...
    def test_forward_no_priors(
        ...
        empty_priors = Priors()
        masks_per_image, points_per_image, boxes_per_image = sam_decoder.forward(
            [sample_image], [empty_priors], None
        )
...
class TestSamDecoderPredictSingle:
    ...
    def test_predict_single_with_points(
        ...
        sam_decoder._predict = MagicMock(return_value=(mock_masks, mock_points, mock_boxes))
    ...
    def test_predict_single_with_boxes(
        ...
        class_points = {}
        class_boxes = {
            0: torch.tensor([[50, 50, 150, 150, 0.9, 1]], dtype=torch.float32)
        }
        labels = [0]
    ...
    def test_predict_single_no_masks(
        ...
        # Mock the _predict method to return empty masks
    ...
    def test_predict_single_multiple_classes(
        ...
        masks, points, boxes = sam_decoder.predict_single(
            class_points, class_boxes, labels, similarities, (480, 640)
        )
...
class TestSamDecoderPredict:
    ...
    def test_predict_with_points_only(
        ...
        """Test _predict with points only."""
        ...
        masks, coords, boxes = sam_decoder._predict(
            points_per_class, boxes_per_class, similarity_map, original_size
        )
    ...
    def test_predict_with_both_points_and_boxes(
        ...
        """Test _predict with both points and boxes."""
...
class TestSamDecoderMaskRefinement:
    ...
    def test_mask_refinement_basic(
        ...
        input_coords = torch.tensor([[[100, 150, 0.9], [200, 250, 0.8]], [[100, 150, 0.9], [200, 250, 0.8]], [[100, 150, 0.9], [200, 250, 0.8]]], dtype=torch.float32)
        ...
        with patch('getiprompt.processes.segmenters.sam_decoder.nms') as mock_nms:
            ...
            refined_masks, refined_coords = sam_decoder.mask_refinement(
                masks, low_res_logits, input_coords, input_labels, original_size,
                similarity_map, score_threshold=0.3, nms_iou_threshold=0.1
            )
    ...
    def test_mask_refinement_no_similarity_map(
        ...
        with patch('getiprompt.processes.segmenters.sam_decoder.nms') as mock_nms:
            ...
            refined_masks, refined_coords = sam_decoder.mask_refinement(
                masks, low_res_logits, input_coords, input_labels, original_size,
                similarity_map=None, score_threshold=0.3, nms_iou_threshold=0.1
            )
    ...
    def test_mask_refinement_empty_similarity_map(
        ...
        with patch('getiprompt.processes.segmenters.sam_decoder.nms') as mock_nms:
            ...
            refined_masks, refined_coords = sam_decoder.mask_refinement(
                masks, low_res_logits, input_coords, input_labels, original_size,
                similarity_map=similarity_map, score_threshold=0.3, nms_iou_threshold=0.1
            )
    ...
    def test_mask_refinement_low_scores(
        ...
        with patch('getiprompt.processes.segmenters.sam_decoder.nms') as mock_nms:
            ...
            refined_masks, refined_coords = sam_decoder.mask_refinement(
                masks, low_res_logits, input_coords, input_labels, original_size,
                similarity_map=similarity_map, score_threshold=0.5, nms_iou_threshold=0.1
            )

...
def prompt_db_to_schema(prompt: PromptDB, include_thumbnail: bool = False) -> PromptSchema:
    """
    Map a PromptDB instance to a PromptSchema object.

    Args:
        prompt: The prompt database entity
        include_thumbnail: If True, includes thumbnail in visual prompt schemas
    """
    ...
    return VisualPromptSchema(
        ...
        thumbnail=prompt.thumbnail if include_thumbnail else None,
    )


def prompts_db_to_schemas(prompts: Iterable[PromptDB], include_thumbnail: bool = False) -> list[PromptSchema]:
    """
    Map a list of PromptDB instances to a list of PromptSchema objects.

    Args:
        prompts: Iterable of prompt database entities
        include_thumbnail: If True, includes thumbnails in visual prompt schemas
    """

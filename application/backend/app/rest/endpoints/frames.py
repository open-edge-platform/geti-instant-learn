...
from services.frame import FrameService, FrameCaptureError
...
def capture_frame(
        project_id: UUID,
        frame_service: Annotated[FrameService, Depends(get_frame_service)]
) -> Response:
...
def get_frame(
    ...
    frame_bytes = frame_service.get_frame(project_id, frame_id)

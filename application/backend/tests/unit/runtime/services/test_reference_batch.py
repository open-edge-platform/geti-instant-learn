...
from domain.services.schemas.annotation import Point, PolygonAnnotation
...
class TestVisualPromptToSample:
    ...
    def test_with_multiple_polygons(self, sample_frame: np.ndarray) -> None:
        ...
        config_2 = PolygonAnnotation(points=[Point(x=320, y=240), Point(x=448, y=336), Point(x=384, y=384)])

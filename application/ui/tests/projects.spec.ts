...
import { ProjectSchemaType } from '../src/api';
...
const registerApiProjects = ({
    ...
    defaultProjects: ProjectSchemaType[];
}) => {
    let projects: ProjectSchemaType[] = [...defaultProjects];
    ...
    network.use(
        ...
        http.post('/api/v1/projects', async ({ response, request }) => {
            ...
            projects.push(body as ProjectSchemaType);
...
test.describe('Projects', () => {
    test.describe('Navigation', () => {
        test("Navigates to the project's details page when the URL contains valid project ID", async ({
            ...
            const project: ProjectSchemaType = {

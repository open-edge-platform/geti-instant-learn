...
See [Recommended Hardware Specifications](https://github.com/open-edge-platform/geti-instant-learn/blob/main/application/docs/02-quick-start.md#recommended-hardware-specifications) for detailed hardware requirements.

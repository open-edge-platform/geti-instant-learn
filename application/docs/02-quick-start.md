...
> **Note:** Pre-built binaries are not yet available. This section will be updated when container images are published to the registry. For now, build and run the application using Docker as described in the [Application README](https://github.com/open-edge-platform/geti-instant-learn/blob/main/application/README.md).

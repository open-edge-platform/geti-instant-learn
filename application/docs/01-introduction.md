...
## What is Geti Instant Learn

Geti Instant Learn empowers edge users, ranging from domain experts to developers and data scientists, to build computer vision models with a single click.

This open-source Python application facilitates users to prompt, run and manage configurable zero-shot/few-shot AI pipelines. Geti Instant Learn can simply be installed and used as a desktop application or deployed as a Docker image directly at the edge.
...
3. **Test** – Geti Instant Learn processes the provided prompt against the visual input stream for immediate evaluation. The user can edit or add prompts at any time to adjust the model output.

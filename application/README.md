...
**Prerequisites:** [uv](https://github.com/astral-sh/uv), [Just](https://github.com/casey/just), Python 3.13, Node.js v24+, [HF token](#configure-HuggingFace-authentication)
...
**Prerequisites:** [Just](https://github.com/casey/just), Docker, [HF token](#configure-HuggingFace-authentication)
